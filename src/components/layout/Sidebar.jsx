...
const NAV_ITEMS = [
  ...
  { divider: true },
  { to: '/', label: 'Calendario', icon: '📅', roles: ['admin', 'admin_ehs', 'ho', 'area', 'store', 'base'] },
  { to: '/corsi', label: 'Elenco Attività', icon: '📝', roles: ['admin', 'admin_ehs', 'ho', 'store'] },
  {
    group: 'Report',
    icon: '📊',
    roles: ['admin', 'admin_ehs', 'ho', 'area', 'store'],
    children: [
      { to: '/completamento', label: '% Completamento', icon: '📈', roles: ['admin', 'admin_ehs', 'ho', 'area', 'store'] },
      { to: '/report',        label: 'Dettaglio',        icon: '🔍', roles: ['admin', 'admin_ehs', 'ho', 'area', 'store'] },
      { to: '/mapping',       label: 'Mapping',          icon: '🗂️', roles: ['admin', 'admin_ehs', 'ho', 'area', 'store'] },
    ],
  },
  { to: '/development',   label: 'Development',      icon: '🚀', roles: ['admin', 'admin_ehs', 'ho', 'area'] },
  { divider: true },
  {
    group: 'Gestione',
    icon: '⚙️',
